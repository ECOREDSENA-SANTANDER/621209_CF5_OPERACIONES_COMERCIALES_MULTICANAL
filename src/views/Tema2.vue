  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    TabsC.color-primario.mb-5(data-aos="zoom-in-left")
      ...
      .py-3.py-md-4.bg26.px-3(titulo="Bombas")
        .row.justify-content-center
          .col-lg-3.col-md-7.col-7.my-3
            img.img-a.img-t(src='@/assets/curso/tema2/img6.png', alt='')
          .col-lg-8.my-3
      ...
      .col-lg-12.col-md-12.col-12.px-4
        ...
        ul.lista-ul.ps-2.mb-2
          li.d-flex.mb-1
            ...
            p.mb-0 
              strong.az Funciones utilitarias: 
        ...
        .row.justify-content-center.align-items-center.mb-5
          .col-lg-9.col-md-12.col-12
            ul.lista-ul.ps-0
              li.d-flex.mb-4
                i.fas.fa-car-side.camisaa
                p.mb-0 
                  strong.az Funciones de valor añadido:
          ...
          .col-lg-3.col-md-7.col-7
            img.img-a.img-t.mb-4(src='@/assets/curso/tema2/img20.png', alt='')
    ...
    .row
      .col-lg-12.mb-4.mb-lg-0(data-aos="fade-right")
        TabsA.color-primario
          .tarjeta.color-acento-botones.bg06.p-4(titulo="Contener")
            .row.justify-content-center.align-items-center
              .col-lg-4.col-md-10.col-10
                img.img-a.img-t(src='@/assets/curso/tema2/01.png', alt='').mb-3
              .col-lg-8.col-md-12.col-12
          ...
          .tarjeta.color-acento-botones.bg06.p-4(titulo="Compatibilidad")
            .row.justify-content-center.align-items-center
              .col-lg-4.col-md-10.col-10
                img.img-a.img-t(src='@/assets/curso/tema2/02.png', alt='').mb-3
              .col-lg-8.col-md-12.col-12
          ...
          .tarjeta.color-acento-botones.bg06.p-4(titulo="Retener")
            .row.justify-content-center.align-items-center
              .col-lg-4.col-md-10.col-10
    ...
    .row.justify-content-center.align-items-center.mb-4(data-aos="fade-right")
      .col-lg-8.col-12
        .bloque-texto-g.color-primario.p-lg-5.p-4
          .bloque-texto-g__img(
