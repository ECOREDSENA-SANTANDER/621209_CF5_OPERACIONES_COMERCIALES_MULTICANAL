  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .col-lg-6.mb-4.mb-lg-0.col-md-10
          .crd_hover_txt
            ...
            .crd_hover_txt--body.colt
              ...
              p.mt-4.mb-0.text-center Se entiende al espacio o superficie total del #[em retail] en metros cuadrados. Este dato se obtiene al adquirir la edificación, ahora bien, hay que restar los espacios no dedicados al almacenaje de mercancías: como son los baños, vestuarios, oficinas, entre otros. 
              p.mt-4.mb-0.text-center En cuanto a la altura máxima de la edificación, esta se obtiene restando elementos, como los sistemas de ventilación, iluminación u otros, a la altura del techo de la bodega.
        .col-lg-6.mb-lg-0.col-md-10(data-aos="zoom-in")
          .crd_hover_txt
            ...
            .crd_hover_txt--body.colt
              ...
              p.mt-4.mb-0.text-center El #[em picking] es la actividad de preparación de pedidos, donde los productos almacenados se seleccionan y preparan para su despacho al #[em retail]. 
              p.mt-4.mb-0.text-center Esta área debe estar organizada de manera eficiente para permitir un acceso rápido y fácil a los productos, optimizando así el tiempo y los recursos empleados en la preparación de los pedidos, garantizando la rapidez y precisión en la distribución.
    ...
    .row.justify-content-center.mb-5(data-aos="fade-down") 
      .col-sm-6.col-xl-4.mb-4.mb-xl-0
        .tarjeta.tarjeta-slide.arriba.bg01.mh-375
          .tarjeta-slide__contenedor
            .tarjeta-slide__contenido.p-4.p-xl-5
              .col-auto 
                img.img-a.img-t.mb-4(src='@/assets/curso/tema1/img14.svg', alt='tema1')
              h2.text-center.mb-4 Materias primas e insumos
              p.text-center Proveniente de uno o varios proveedores. En esta categoría también se deben incluir insumos como: papelería, productos de aseo y consumo para las oficinas, dotaciones para los empleados, entre otros.
            .tarjeta-slide__img(:style="{'background-image': `url(${require('@/assets/curso/tema1/img11.svg')})`}")
      .col-sm-6.col-xl-4.mb-4.mb-xl-0
        .tarjeta.tarjeta-slide.arriba.bg01.mh-375(@mouseover="indicadorTarjetaSlide = false")
          .indicador--hover(v-if="indicadorTarjetaSlide")
          .tarjeta-slide__contenedor
            .tarjeta-slide__contenido.p-4.p-xl-5
              .col-auto 
                img.img-a.img-t.mb-4(src='@/assets/curso/tema1/img15.svg', alt='tema1')
              h2.text-center.mb-4 Producto en proceso
              p.text-center Proveniente de una o varias plantas de producción. 
        ...
        .tarjeta.tarjeta-slide.arriba.bg01.mh-375
          .tarjeta-slide__contenedor
            .tarjeta-slide__contenido.p-4.p-xl-5
              ...
              h2.text-center.mb-4 Producto terminado
              p.text-center Proveniente de una planta de producción o de un proveedor.
